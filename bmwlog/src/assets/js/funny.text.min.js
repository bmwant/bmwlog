/**
 * Adtopted to work with Vue based on
 * https://github.com/alvarotrigo/funnyText.js
 */
import $ from 'jquery'

export function funnyText(selector, options) {
    ...
    console.log(options);
		...
		var normalPositionX, normalPositionY;
    var activePositionXY;
    var previousPosition;
		...
		var style = $('<style>'+selector +'.funnyText span.active { color: ' + options.activeColor + '; text-shadow: -1px 0 '+options.borderColor+', 0 1px '+options.borderColor+', 1px 0 '+options.borderColor+', 0 -1px '+options.borderColor+';} '+selector +'.funnyText span{color: ' + options.color +'; font-size:' + options.fontSize + ';}</style>')
		...
		*/
		...
		$('.charWrap').on('mouseenter', function () {
